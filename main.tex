...
\centering
    ...
    \vspace{-1.0pc}
    \caption{The PMT mosaic of the SPHERE-2 detector with PMTs numbers indicated, and view of relative time arriving EAS light on PMTs, where Npmt- number of each PMT in mosaic,t – relative time (bin = 12.5 nS).}
\label{fig:mosaic_sine}
\end{figure}


The PMT mosaic is located near the mirror focal surface and records the Cherenkov light reflected from the snow surface below the detector. PMTs are arranged in the hexagonal structure on the spherical surface as shown on Fig.~\ref{fig:mosaic}. 
...
\begin{table}[b]
\centering
\caption{The annual statistics of the SPHERE experiment on Baikal Lake\todoi{Уточнить статистику по 2008-2009 годам.}}
...
\todoi{Не забыть Шаулова, Домогацкого и кто там ещё}
