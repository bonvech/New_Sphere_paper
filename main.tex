...
{
\Russian
Эта статья является продолжением серии итоговых статей по эксперименту с установкой СФЕРА-2, начатой статьей~\cite{SPHERE21}, в которой описываются условия проведения эксперимента и контроль параметров установки.
}
...
The SPHERE-2 detector recorded more than 30 thousands trigger event frames but not all of them was caused by signals of the EAS Cherenkov light. The separation of EAS events is the task on this section. 
